...
@section('editRight')
        <div class="mt-2">
            ...
            <input type="text" class="w-full px-5 py-1 text-gray-300 rounded" name="name">
            <input type="text" class="w-full px-5 py-1 text-gray-300 rounded" name="selling_price" >
            <input type="text" class="w-full px-5 py-1 text-gray-300 rounded" name="quantities" >
        </div>
