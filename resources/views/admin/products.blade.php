                ...
                <div class="w-full mt-12 lg:w-1/2 pl-0 lg:pl-2">
                    <div class="p-10 rounded">
                        ...
                        <div class="mt-5 flex justify-end">
                            ...
                            <input class=" w-1/2 px-5 py-1 text-gray-300 rounded" id="supply_price" name="supply_price" type="number" required="" placeholder="공급가" aria-label="Supply_Price">
                        </div>
                        <div class="mt-2 flex justify-end">
                            <label class="block mr-2 text-sm text-gray-600" for="selling_price">판매가 (원)</label>
                            <input class="w-1/2 px-5 py-1 text-gray-300 rounded" id="selling_price" name="selling_price" type="number" required="" placeholder="판매가" aria-label="Selling_Price">
                        </div>
                        <div class="mt-2 flex justify-end">
                            <label class="block mr-2 text-sm text-gray-600" for="delivery_fee">배송비 (원)</label>
                            <input class="w-1/2 px-5 py-1 text-gray-300 rounded" id="delivery_fee" name="delivery_fee" type="number" required="" placeholder="배송비" aria-label="Delivery_Fee">
                        </div>
                        <div class="mt-2 flex justify-end">
                            <label class="block mr-2 text-sm text-gray-600" for="stock_amount">재고 (EA)</label>
                            <input class="w-1/2 px-5 py-1 text-gray-300 rounded" id="stock_amount" name="stock_amount" type="number" required="" placeholder="수량" aria-label="stock_amount">
                        </div>
