  ...
  <div class="flex">
    <div class="top-0 left-0 h-40 w-full md:h-40">
      <div class="py-8 px-4 text-center sm:px-10 lg:px-10">
        ...
        <form class="flex justify-center pt-6 md:pt-8" method="GET" action="{{ route('search') }}">
          <input
            type="text"
            name="word"
      ...
      @if ($products !== "empty")
        ...
        <div class="group relative w-full lg:last:hidden xl:last:block">
          ...
          <div class="flex items-center justify-between pt-6">
            ...
            <span class="font-hk text-xl font-bold text-primary">{{ number_format($product->selling_price) }} 원</span>
          </div>
        </div>
        @endforeach
      @elseif ($products == "zero")
          <div class="relative flex items-center justify-center rounded">
            <p>찾으시는 상품이 없습니다.</p>
          </div>
      @endif
